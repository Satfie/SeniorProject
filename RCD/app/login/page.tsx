...
import { Loader2, ArrowRight, Shield, Gamepad2 } from "lucide-react"
      ...
      <div className="hidden lg:flex w-1/2 bg-black relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-20 p-12 text-center max-w-lg">
          <div className="mb-8 flex justify-center">
            <div className="w-24 h-24 flex items-center justify-center shadow-2xl shadow-primary/30 animate-float">
              <Logo size={96} />
            </div>
          </div>
